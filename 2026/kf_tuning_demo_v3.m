...
bad  = struct('Q',0.01, 'R',1.0);     % Q,R too small -> sluggish AND over-confident
...
title(axG,sprintf('BAD tuning:  Q = %.2f,  R = %.2f   (too small \\rightarrow sluggish & over-confident)',bad.Q,bad.R),'FontSize',13);
