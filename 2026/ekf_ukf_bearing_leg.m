...
for k=1:N
    ...
    hR=plot(ax,nan,nan,'-','Color',cRay,'LineWidth',2);
    hE=plot(ax,nan,nan,'--','Color',cEKF,'LineWidth',2);
    hU=plot(ax,nan,nan,'-','Color',cUKF,'LineWidth',2);
    legend(ax,[hT hR hE hU],{'true','bearing ray','EKF','UKF'},'Location','northoutside','Orientation','horizontal','FontSize',11,'Box','off');
