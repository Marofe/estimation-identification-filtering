...
bad  = struct('Q',0.02, 'R',0.4);     % both far too small -> over-confident
...
title(axG,sprintf('BAD tuning:  Q = %.2f,  R = %.2f   (too small \\rightarrow sluggish, biased)',bad.Q,bad.R),'FontSize',13);
