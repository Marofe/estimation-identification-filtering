...
%% ---- parameters ----
T=1.0; N=60;
sig_r=2.0; sig_th=deg2rad(2.5); R=diag([sig_r^2, sig_th^2]);
...
for k=1:N-1
    ...
    elseif k==50, x(5,k)=deg2rad(-2.4); end
...
x0=x(:,1)+[24;-24;3;deg2rad(55);deg2rad(4.5)];
P0=diag([28^2,28^2,5^2,deg2rad(55)^2,deg2rad(9)^2]);
